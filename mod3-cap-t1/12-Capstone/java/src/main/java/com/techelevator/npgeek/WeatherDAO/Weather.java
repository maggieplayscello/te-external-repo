...
public class Weather {
	...
	public String toString() {
		return "Weather [parkCode=" + parkCode + ", fiveDayForecastValue=" + fiveDayForecastValue + ", low=" + low
				+ ", high=" + high + ", forecast=" + forecast + ", hashCode()=" + hashCode() + ", getParkCode()="
				+ getParkCode() + ", getFiveDayForecastValue()=" + getFiveDayForecastValue() + ", getLow()=" + getLow()
				+ ", getHigh()=" + getHigh() + ", getForecast()=" + getForecast() + ", getClass()=" + getClass()
